    ...
    $.fn.wrpage = function(options) {
        ...
        function init(size, cur) {
            ...
            if (cur <= 1) {
                ...
                _html +=
                    '<li class="wr_pagefirst"><a href="javascript:;"><i class="fa fa-chevron-left"></i></a></li>'
            }
            //中间
            if (cur < 4) {
                ...
                for (var i = 1; i <= midpage; i++) {
                    if (i == cur) {
                        _html += '<li class="active curwrpage"><a>' + cur + '</a></li>'
                    } else {
            ...
            if (cur >= size) {
                ...
                _html +=
                    '<li class="wr_pagenext"><a href="javascript:;"><i class="fa fa-chevron-right"></i></a></li><li class="wr_pageend"><a href="javascript:;">尾</a></li>'
            }
            em.append(_html)
        }
