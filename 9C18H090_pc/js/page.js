    ...
    $.fn.wrpage = function(options) {
        ...
        function init(size, cur) {
            ...
            if (cur <= 1) {
                ...
                _html +=
                    '<li class="wr_pagefirst"><a href="javascript:;" class="prev page-numbers">上页</a></li>'
            }
            //中间
            if (cur < 4) {
                ...
                for (var i = 1; i <= midpage; i++) {
                    if (i == cur) {
                        _html += '<li class="curwrpage active"><span class="page-numbers current">' + cur + '</span></li>'
                    } else {
                        _html += '<li class="wrpage_number"><a href="javascript:;" class="page-numbers">' + i + '</a></li>'
                    }
                }
            } else if (cur >= 4) {
            ...
            if (cur >= size) {
                ...
                _html +=
                    '<li class="wr_pagenext"><a href="javascript:;" class="next page-numbers">下页</a></li><li class="wr_pageend"><a href="javascript:;">尾页</a></li>'
            }
            em.append(_html)
        }
